...
import { WorkerService, ActiveSeasonService } from '../../services/database.service';
  ...
  useEffect(() => {
    const loadData = async () => {
      try {
        ...
        const activeSeason = await ActiveSeasonService.get(currentProfile.id);
        const activeSeasonHardcodedId = activeSeason?.activeSeasonId || null;

        if (currentProfile.seasons) {
